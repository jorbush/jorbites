                ...
                <div className="rounded-xl border border-neutral-200 bg-transparent p-3 transition-colors focus-within:border-neutral-300 dark:border-neutral-700 dark:focus:border-neutral-600">
                    ...
                    <div className="relative">
                        <MentionInput
                            ...
                            className="min-h-[38px] w-full resize-none overflow-y-auto border-0 bg-transparent p-0 text-base md:text-sm text-neutral-900 placeholder:text-neutral-400 focus:ring-0 focus:outline-hidden dark:text-neutral-100 dark:placeholder:text-neutral-500"
