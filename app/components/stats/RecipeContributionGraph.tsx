...
const RecipeContributionGraph: React.FC<RecipeContributionGraphProps> = ({
    ...
    // On mobile / small screens, scroll to the far right on mount so user sees today's recent activity
    useEffect(() => {
    ...
    const showTooltipForElement = (day: DayData, target: HTMLElement) => {
        setHoveredDay(day);
    ...
    const handleDayHover = (
        ...
        showTooltipForElement(day, event.currentTarget);
    };
                    ...
                    >
                        <div className="relative inline-flex min-w-[600px] flex-col">
                            ...
                            <div className="mb-2 flex min-w-[600px] gap-0.5 sm:gap-1">
                                {/* Sticky spacer to match day labels column width */}
                            ...
                            <div className="flex gap-0.5 sm:gap-1">
                                {/* Day of week labels - sticky on horizontal scroll */}
                            ...
                            {/* Tooltip (PURELY FLOATING - NO LAYOUT SHIFT) */}
                            {hoveredDay &&
                                tooltipPosition &&
                                hoveredDay.count > 0 && (
                                    <div
