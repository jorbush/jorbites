        ...
        <Container>
            <div className="w-full py-4">
                ...
                <div className="mb-4 px-2">
                    <div className="h-6 w-64 animate-pulse rounded bg-neutral-200 dark:bg-neutral-700 sm:h-7"></div>
                </div>
                                        ...
                                        >
                                            {Array.from({ length: 7 }).map(
                                                (_, dayIndex) => (
                                                    <div
                                                        key={dayIndex}
                                                        className="h-2.5 w-2.5 animate-pulse rounded-sm bg-neutral-200 dark:bg-neutral-700 sm:h-3 sm:w-3"
                                                    />
                                                )
                                            )}
                                        </div>
