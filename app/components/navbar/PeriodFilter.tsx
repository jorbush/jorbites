...
const PeriodFilter: React.FC = () => {
    ...
    return (
        ...
        >
            ...
            {isOpen && (
                <div
                    className="dark:bg-dark/97 absolute top-12 right-0 z-50 min-w-[280px] rounded-xl border border-neutral-200/40 bg-white/97 p-4 shadow-[0_2px_20px_rgba(0,0,0,0.03)] backdrop-blur-lg transition-all duration-300 dark:border-neutral-800/40 dark:shadow-[0_2px_20px_rgba(0,0,0,0.15)]"
                    style={{
