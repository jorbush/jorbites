...
export const MobileSearch: React.FC<MobileSearchProps> = ({
    ...
    return (
        <div className="flex w-full flex-row items-center gap-1">
            {isSearchMode ? (
                <div className="animate-mobile-search-in flex w-full items-center gap-2">
                    <button
                        type="button"
                        onClick={onSearchToggle}
                        className="flex min-h-[40px] min-w-[40px] shrink-0 cursor-pointer items-center justify-center rounded-full p-2 text-neutral-600 hover:bg-neutral-100 dark:text-neutral-400 dark:hover:bg-neutral-800"
                    ...
                    <button
                        ...
                        className={`relative shrink-0 cursor-pointer rounded-full p-2 shadow-xs transition hover:shadow-md ${
                            isFilterOpen
                    ...
                    >
                        ...
                        <button
                            type="submit"
                            className="bg-green-450 dark:text-dark relative flex min-h-[40px] min-w-[40px] shrink-0 cursor-pointer items-center justify-center rounded-full p-2 text-white shadow-xs transition hover:shadow-md"
