        ...
        <div className="flex items-center gap-2.5 sm:gap-3">
            <Tooltip text={t('my_drafts') || 'My Drafts'}>
                <button
                    ...
                    className="hover:text-green-450 dark:hover:text-green-450 relative flex cursor-pointer items-center justify-center text-xl text-black transition dark:text-neutral-100"
                >
                    <FiFolder />
                    {hasDrafts && (
                        <span
            ...
            <Tooltip text={t('save_draft_tooltip') || 'Save draft'}>
                <button
                    ...
                    className="hover:text-green-450 dark:hover:text-green-450 flex cursor-pointer items-center justify-center text-xl text-black transition dark:text-neutral-100"
                >
                    <FiUploadCloud />
                </button>
            </Tooltip>
