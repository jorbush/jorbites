    ...
    return (
        <div className="relative w-full">
            ...
            <input
                ...
                type={type}
                maxLength={maxLength}
                className={`peer w-full rounded-md border-2 bg-white p-4 pt-6 font-light text-zinc-900 outline-hidden transition disabled:cursor-not-allowed disabled:opacity-70 dark:bg-zinc-800 dark:text-zinc-100 ${type === 'date' || type === 'datetime-local' ? 'flex-shrink' : ''} ${formatPrice ? 'pl-9' : 'pl-4'} ${
                    errors[id]
                        ? 'border-rose-500'
