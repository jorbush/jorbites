...
interface JorbitesBasicsOverviewProps {
    completedModules: Record<string, boolean>;
    markModuleCompleted: (id: string) => void;
    onNext: () => void;
}

const JorbitesBasicsOverview: React.FC<JorbitesBasicsOverviewProps> = ({
    completedModules,
    markModuleCompleted,
    onNext,
}) => {
        ...
        <div className="rounded-2xl border border-neutral-200 bg-white p-6 shadow-sm md:p-8 dark:border-neutral-800 dark:bg-neutral-900">
            <div className="mb-6 flex items-center gap-3">
                ...
                <h2 className="text-2xl font-bold text-neutral-900 dark:text-white">
                    {t('jorbites_basics_course_details.requirements_title')}
                </h2>
            </div>

            <div className="space-y-6">
                <p className="text-sm text-neutral-600 dark:text-neutral-400">
                    {t('jorbites_basics_course_details.requirements_intro')}
                </p>
                ...
                <div className="grid grid-cols-1 gap-4 md:grid-cols-2">
                    <div className="rounded-xl border border-neutral-100 bg-white p-4 dark:border-neutral-800 dark:bg-neutral-900">
                        <h4 className="font-semibold text-neutral-900 dark:text-white">
                            {t(
                                'jorbites_basics_course_details.req_recipes_label'
                            )}
                        </h4>
                        <p className="mt-1 text-xs text-neutral-600 dark:text-neutral-400">
                            {t(
                                'jorbites_basics_course_details.req_recipes_desc'
                            )}
                        </p>
                    </div>
                    <div className="rounded-xl border border-neutral-100 bg-white p-4 dark:border-neutral-800 dark:bg-neutral-900">
                        ...
                        <p className="mt-1 text-xs text-neutral-600 dark:text-neutral-400">
                            {t(
                                'jorbites_basics_course_details.req_interactions_desc'
                            )}
                        </p>
                    </div>
                    <div className="rounded-xl border border-neutral-100 bg-white p-4 dark:border-neutral-800 dark:bg-neutral-900">
                        <h4 className="font-semibold text-neutral-900 dark:text-white">
                            {t(
                                'jorbites_basics_course_details.req_lists_label'
                            )}
                        </h4>
                        <p className="mt-1 text-xs text-neutral-600 dark:text-neutral-400">
                            {t('jorbites_basics_course_details.req_lists_desc')}
                        </p>
                    </div>
                    <div className="rounded-xl border border-neutral-100 bg-white p-4 dark:border-neutral-800 dark:bg-neutral-900">
                        <h4 className="font-semibold text-neutral-900 dark:text-white">
                        ...
                        <p className="mt-1 text-xs text-neutral-600 dark:text-neutral-400">
                            {t(
                                'jorbites_basics_course_details.req_settings_desc'
                            )}
                        </p>
                    </div>
                </div>
                ...
                <div className="rounded-xl bg-neutral-50 p-6 dark:bg-neutral-800/30">
                    <h4 className="mb-4 text-sm font-bold text-neutral-800 dark:text-neutral-200">
                        {t('jorbites_basics_course_details.action_required')}
                    </h4>
                    <div className="space-y-3">
                        <label className="flex cursor-pointer items-start gap-3">
                            <input
                                type="checkbox"
                                checked={isCompleted || overviewChecked.recipes}
                        ...
                        <label className="flex cursor-pointer items-start gap-3">
                            <input
                                type="checkbox"
                                checked={
                                    isCompleted || overviewChecked.interactions
                                }
                                onChange={() =>
                                    handleOverviewCheck('interactions')
                                }
                                className="mt-1 accent-green-600"
                        ...
                        <label className="flex cursor-pointer items-start gap-3">
                            <input
                                type="checkbox"
                                checked={isCompleted || overviewChecked.lists}
                        ...
                        <label className="flex cursor-pointer items-start gap-3">
                            <input
                                type="checkbox"
                                checked={
                                    isCompleted || overviewChecked.settings
                                }
...
export default JorbitesBasicsOverview;
