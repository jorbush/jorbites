...
describe('<Avatar/>', () => {
    ...
    it('should render with default size and placeholder image when src is null', () => {
        ...
        expect(img).toHaveProperty('src', 'http://localhost:3000/_next/image?url=%2Fimages%2Fplaceholder.jpg&w=64&q=75');
    ...
    it('should render with provided src and size', () => {
        ...
        const img = screen.getByAltText('Avatar');
        expect(img).toBeDefined();
        expect(img).toHaveProperty('src', 'http://localhost:3000/_next/image?url=https%3A%2F%2Fexample.com%2Favatar.jpg&w=128&q=75');
    ...
    it('should call onClick handler when clicked', () => {
        ...
        render(<Avatar src="https://example.com/avatar.jpg" onClick={handleClick} />);
    ...
    it('should not have cursor-pointer class when onClick is not provided', () => {
        ...
        expect(screen.getByAltText('Avatar')).not.toHaveProperty('cursor-pointer');
    });

    it('should have cursor-pointer class when onClick is provided', () => {
        render(<Avatar src="https://example.com/avatar.jpg" onClick={() => {}} />);
        expect(screen.getByAltText('Avatar').className).include('cursor-pointer');
    });
});
