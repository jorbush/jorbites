...
describe('PlanningClient', () => {
    ...
    it('hides add recipe button when meal limit (4) is reached', () => {
        const fullMeals = [
            { id: '1', day: 'monday', mealType: 'breakfast', recipeId: 'r1', recipe: { title: 'R1', imageSrc: '' } },
            { id: '2', day: 'monday', mealType: 'breakfast', recipeId: 'r2', recipe: { title: 'R2', imageSrc: '' } },
            { id: '3', day: 'monday', mealType: 'breakfast', recipeId: 'r3', recipe: { title: 'R3', imageSrc: '' } },
            { id: '4', day: 'monday', mealType: 'breakfast', recipeId: 'r4', recipe: { title: 'R4', imageSrc: '' } },
        ];
        ...
        const mealSlots = dayContainer!.querySelectorAll('[data-testid="meal-slot"]');
        ...
        const addButton = breakfastSlot!.querySelector('[data-testid="add-recipe-button"]');
