...
vi.mock('@/app/components/settings/EmailNotificationsSelector', () => ({
    default: () => <div>EmailNotificationsSelector</div>,
}));
...
describe('SettingsModal', () => {
    ...
    it('renders the settings modal', () => {
        ...
        expect(screen.getByText('set_your_preferences')).toBeDefined();
        expect(screen.getByText('ThemeSelector')).toBeDefined();
        expect(screen.getByText('LanguageSelector')).toBeDefined();
    });
    ...
    it('renders user-specific settings when currentUser is provided', () => {
        ...
        expect(screen.getByText('EmailNotificationsSelector')).toBeDefined();
        expect(screen.getByText('ChangeUserImageSelector')).toBeDefined();
    });
});
